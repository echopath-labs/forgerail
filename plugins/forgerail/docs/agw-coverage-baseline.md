...
This historical map is retained as architecture provenance. The replacement implementation has a [self-contained behavior inventory](agw-replacement-coverage.json)
