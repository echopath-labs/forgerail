...
assert(candidate.status === "local_010_candidate", "candidate status is local 0.1.0 integrity preparation");
...
assert(candidate.plugin.version === "0.1.0", "candidate version is 0.1.0");
...
assert(candidate.releaseNotes.state === "candidate" && candidate.releaseNotes.path === "./directory/release-notes-0.1.0.md", "0.1.0 release notes path is explicit");
assert(existsSync(resolve(pluginRoot, candidate.releaseNotes.path)), "0.1.0 release notes file exists");
