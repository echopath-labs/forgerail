...
assert(candidate.status === "local_011_candidate", "candidate status is local 0.1.1 integrity preparation");
...
assert(candidate.plugin.version === "0.1.1", "candidate version is 0.1.1");
...
assert(candidate.releaseNotes.state === "candidate" && candidate.releaseNotes.path === "./directory/release-notes-0.1.1.md", "0.1.1 release notes path is explicit");
assert(existsSync(resolve(pluginRoot, candidate.releaseNotes.path)), "0.1.1 release notes file exists");
