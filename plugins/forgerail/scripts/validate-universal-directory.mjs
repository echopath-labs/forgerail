...
assert(candidate.status === "local_016_candidate", "candidate status is local 0.1.6 integrity preparation");
...
assert(candidate.plugin.version === "0.1.6", "candidate version is 0.1.6");
...
assert(candidate.releaseNotes.state === "candidate" && candidate.releaseNotes.path === "./directory/release-notes-0.1.6.md", "0.1.6 release notes path is explicit");
assert(existsSync(resolve(pluginRoot, candidate.releaseNotes.path)), "0.1.6 release notes file exists");
