...
assert(candidate.status === "local_013_candidate", "candidate status is local 0.1.3 integrity preparation");
...
assert(candidate.plugin.version === "0.1.3", "candidate version is 0.1.3");
...
assert(candidate.releaseNotes.state === "candidate" && candidate.releaseNotes.path === "./directory/release-notes-0.1.3.md", "0.1.3 release notes path is explicit");
assert(existsSync(resolve(pluginRoot, candidate.releaseNotes.path)), "0.1.3 release notes file exists");
