...
export function validateRelease() {
  ...
  const releaseEnglish = read("docs/release-0.1.0.md");
  const releaseChinese = read("docs/release-0.1.0.zh-CN.md");
