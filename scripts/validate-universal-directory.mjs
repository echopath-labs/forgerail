...
assert(candidate.status === "local_012_candidate", "candidate status is local 0.1.2 integrity preparation");
...
assert(candidate.plugin.version === "0.1.2", "candidate version is 0.1.2");
...
assert(candidate.releaseNotes.state === "candidate" && candidate.releaseNotes.path === "./directory/release-notes-0.1.2.md", "0.1.2 release notes path is explicit");
assert(existsSync(resolve(pluginRoot, candidate.releaseNotes.path)), "0.1.2 release notes file exists");
