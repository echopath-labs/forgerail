...
assert(candidate.status === "local_alpha5_replacement_candidate", "candidate status is local alpha.5 integrity preparation");
...
assert(candidate.plugin.version === "0.1.0-alpha.5", "candidate version is alpha.5");
...
assert(candidate.releaseNotes.state === "candidate" && candidate.releaseNotes.path === "./directory/release-notes-alpha5.md", "alpha.5 release notes path is explicit");
assert(existsSync(resolve(pluginRoot, candidate.releaseNotes.path)), "alpha.5 release notes file exists");
...
for (const path of ["PRIVACY.md", "TERMS.md", "README.md", "README.zh-CN.md", "docs/installation.md", "docs/installation.zh-CN.md", "docs/release-alpha5.md", "docs/release-alpha4.zh-CN.md"]) {
